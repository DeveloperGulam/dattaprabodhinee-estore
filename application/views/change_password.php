...
<head>
		...
		<title>Dattaprabodhinee E-Store - Vendor Sign Up</title>
						...
						<div class="sign-inner">
							...
							<?php } ?>
								<div class="form-inpts checout-address-step">
									<form action="<?php echo base_url('Welcome_controller/change_this_password');?>" method="post">
										<div class="form-title"><h6>Change Password</h6></div>
										<div class="form-group pos_rel">
											<label class="control-label">New Password</label>
											<div class="form-group pos_rel">
											<input name="npassword" id="otp" type="password" placeholder="Enter New Password"  class="form-control lgn_input" required="">
											    <i class="uil uil-padlock lgn_icon"></i>
										    </div>
											<label class="control-label">Confirm Password</label>
											<div class="form-group pos_rel">
											<input name="cpassword" id="otp" type="text" placeholder="Confirm Password"  class="form-control lgn_input" required="">
											    <i class="uil uil-padlock lgn_icon"></i>
										    </div>
										</div>
										<button class="login-btn hover-btn" type="submit">Change Password</button>
									</form>
								</div>
