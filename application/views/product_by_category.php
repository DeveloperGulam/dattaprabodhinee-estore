...
<?php foreach($new_products as $latest_products){ }?>
<!-- Body Start -->
	<div class="wrapper">
					...
					<div class="col-md-12">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active" aria-current="page"><?php echo strtolower(str_replace('-', ' ',$this->uri->segment(2)));?></li>
							</ol>
						</nav>
					</div>
				</div>
					...
					<div class="col-lg-12">
						<div class="product-top-dt">
							<div class="product-left-title">
								<h2><?php echo strtolower(str_replace('-', ' ',$this->uri->segment(2)));?></h2>
							</div>
