...
<head>
		...
		<title>Dattaprabodhinee - Signin</title>
						...
						<div class="sign-inner">
							...
							<?php } ?>
								<div class="form-inpts checout-address-step">
									<form action="<?php echo base_url('Welcome_controller/otp_user_login');?>" method="post">
										...
										<button class="g-recaptcha login-btn hover-btn" name="login" type="submit">Submit</button>
									</form>
								</div>
								<div class="password-forgor">
									<a href="<?php echo base_url('login/');?>">Login With Password</a>
								</div>
