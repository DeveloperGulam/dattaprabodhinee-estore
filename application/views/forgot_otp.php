...
<head>
		...
		<title>Dattaprabodhinee E-Store - Forgot OTP</title>
						...
						<div class="sign-inner">
							...
							<?php } ?>
								<div class="form-inpts checout-address-step">
									<form action="<?php echo base_url('Welcome_controller/verify_forgot_otp');?>" method="post">
										...
										<a href="<?php echo base_url('Welcome_controller/resend_forgot_otp');?>" class="resend-link">Resend Code</a>
										</div>
