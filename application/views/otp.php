							...
							<?php } ?>
								<div class="form-inpts checout-address-step">
									<form action="<?php echo base_url('Welcome_controller/verify_otp');?>" method="post">
										...
										<a href="<?php echo base_url('Welcome_controller/resend_otp_again');?>" class="resend-link">Resend Code</a>
										</div>
										<button class="login-btn hover-btn" type="submit">Verify OTP</button>
									</form>
								</div>
								<div class="signup-link">
									<p>I have an account? - <a href="<?php echo base_url('login');?>">Login</a></p>
								</div>
							</div>
						</div>
					</div>
