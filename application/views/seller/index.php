                        ...
                        <div class="row">
                            ...
                            <!--<div class="col-xl-6 col-md-6 col-sm-6 col-xs-6">
								<div class="card card-static-1 mb-30">
									<div class="card-body"><i class="fas fa-shopping-cart"></i> Total Sales <b>₹<?php echo $seller_details->wallet_balance;?>.00</b>
									</div>
								</div>
							</div>-->
							<div class="col-xl-12 col-md-12 col-sm-12 col-xs-12">
								<div class="card card-static-1 mb-30">
									<div class="card-body"><i class="fas fa-wallet"></i> Your Earning <b>₹<?php echo $seller_details->wallet_balance;?>.00</b>
									</div>
								</div>
							</div>
							...
							<div class="col-xl-12 col-md-12">
								<div class="card card-static-2 mb-30">
									<div class="card-title-2">
										<h4>Recent Orders</h4>
										<a href="<?php echo base_url('seller/orders/');?>" class="view-btn hover-btn">View All</a> 
									</div>
											...
											<table class="table ucp-table table-hover">
												<thead>
													<tr>
														...
														<th style="width:130px">Your Earning</th>
												...
												<?php foreach($order_details as $order_details){?>
													<tr>
														...
														<td class="text-center">₹<?php echo $order_details->sub_total; ?></td>
														<td><a class="btn btn-primary btn-sm" href="<?php echo base_url('seller/Report/').strtolower(str_replace(' ', '-',$order_details->order_no)).'/'.strtolower(str_replace(' ', '-',$order_details->id));?>">View</a></td>
														<td class="action-btns">
															<a type="button" class="btn btn-primary btn-sm text-white" href="<?php echo base_url('seller/order_details/').strtolower(str_replace(' ', '-',$order_details->order_no)).'/'.strtolower(str_replace(' ', '-',$order_details->id));?>" class="views-btn"><i class="fas fa-eye"></i> details</a>
															<a type="button" class="btn btn-success btn-sm text-white" href="<?php echo base_url('seller/edit_order/').strtolower(str_replace(' ', '-',$order_details->order_no)).'/'.strtolower(str_replace(' ', '-',$order_details->id));?>" class="edit-btn"><i class="fas fa-edit"></i> edit</a>
														</td>
													</tr>
												<?php }?>
												</tbody>
