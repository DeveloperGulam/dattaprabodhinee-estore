												...
												<tbody>
													...
													foreach($order_details as $order_details){
														...
														<td class="action-btns">
															<a type="button" class="btn btn-primary btn-sm text-white" href="<?php echo base_url('seller/order_details/').strtolower(str_replace(' ', '-',$order_details->order_no)).'/'.strtolower(str_replace(' ', '-',$order_details->id));?>" class="view-shop-btn" title="View"><i class="fas fa-eye"></i> details</a>
															<a type="button" class="btn btn-success btn-sm text-white" href="<?php echo base_url('seller/edit_order/').strtolower(str_replace(' ', '-',$order_details->order_no)).'/'.strtolower(str_replace(' ', '-',$order_details->id));?>" class="edit-btn" title="Edit"><i class="fas fa-edit"></i> edit</a>
														</td>
													</tr>
													<?php }?>
												</tbody>
