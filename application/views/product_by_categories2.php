					...
					<div class="col-md-12">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active" aria-current="page"><?php echo $category_name2;?></li>
							</ol>
						</nav>
					</div>
				</div>
					...
					<div class="col-lg-12">
						<div class="product-top-dt">
							<div class="product-left-title">
								<h2><?php echo $category_name2;?> <span class="text-danger">( MRP - <?php echo $total_category_price;?> )</span></h2>
								
							</div>
							<div class="product-sort">
								<form action="<?php echo base_url('Welcome_controller/add_to_cart2/'.$category_info->id).'/shop-by-categories/14/utara-upaay/'; ?>" method="post">
                		        <input type="hidden" name="qty" value="1">
                            <button class="btn btn-danger">👉 Add To Cart (For Buy)</button>
                            </form>
							</div>
