											...
											<table class="table ucp-table table-hover" id="table_id">
												<thead>
													<tr>
														...
														<th style="width:130px">Assign Order</th>
												...
												<tbody>
													...
													foreach($order_details as $order_details){
														...
														<td>#<?php echo $order_details->flat; ?>, <?php echo $order_details->street; ?>, <?php echo $order_details->locality; ?>, <?php echo $order_details->pincode; ?></td>
														
														<td>₹<?php echo $order_details->total_amount; ?></td>
														<td><a class="btn btn-primary btn-sm" href="<?php echo base_url('admin/assign_order/').strtolower(str_replace(' ', '-',$order_details->order_no)).'/'.strtolower(str_replace(' ', '-',$order_details->id));?>" class="edit-btn" title="Edit">Assign Order</a></td>
