									...
									<div class="invoice-content">
										<div class="row">
											...
											<div class="col-lg-5">
												...
												<form action="<?php echo base_url('admin/assign_now/'.$order_info->id); ?>" method="post">
													<label for="status">Status*</label>
													<div class="input-group">
														<select id="seller_id" name="seller_id" class="custom-select">
															<option selected disabled>Pincodes</option>
															<?php foreach($seller_details as $seller_details){?>
															<option value="<?php echo $seller_details->id; ?>"><?php echo $seller_details->pincode; ?> - <?php echo $seller_details->name; ?></option>
															<?php }?>
														</select>
														<div class="input-group-append">
															<button class="status-btn hover-btn" type="submit">Assign</button>
														</div>
													</div>
												</form>
												</div>
