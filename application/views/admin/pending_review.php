										...
										<div class="table-responsive">
    										...
    										<!--			</td>-->
														<td class="action-btns">
															<a type="button" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure want to accept this ?')" href="<?= base_url('admin/accept_review/').$data->id;?>" title="Accept">Accept</i></a>
														</td>
													</tr>
													<?php }?>
												</tbody>
