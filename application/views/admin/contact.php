												...
												<tbody>
													...
													<tr>
														...
														<td class="action-btns">
															<a onclick="DeleteConfirm('<?php echo $customer->id; ?>')" href="javascript:;" class="delete-btn" title="Edit"><i class="fas fa-trash-alt"></i> Delete</a>
														</td>
													</tr>
													<?php }?>
												</tbody>
...
<script type="text/javascript">
  var redirect_url="<?php echo base_url('admin/contact/');?>";
  var url="<?php echo base_url('admin/deleteItem/').strtolower(str_replace(' ', '-',$customer->id)).'/contact/';?>";
