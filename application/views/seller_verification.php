			...
			<div class="row justify-content-center">
				<div class="col-lg-5">
						...
						<div class="sign-inner">
							...
							<?php } ?>
								<div class="form-inpts checout-address-step">
									<form action="<?php echo base_url('Seller/verify_otp');?>" method="post">
										<div class="form-title"><h6>OTP Verification</h6></div>
										<div class="form-group pos_rel">
											<label class="control-label">Enter Code</label>
											<div class="form-group pos_rel">
											<input name="otp" id="otp" type="tel" placeholder="Enter OTP" class="form-control lgn_input" required="">
					...
					<div class="copyright-text text-center mt-3">
						<i class="uil uil-copyright"></i>Copyright 2020 <b>Dattaprabodhinee</b> . All rights reserved
					</div>
				</div>
			</div>
		</div>
