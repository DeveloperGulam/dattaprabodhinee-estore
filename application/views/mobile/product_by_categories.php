...
foreach($new_products as $latest_products){
    $total_category_price+=$latest_products->price;
        ...
        <div class="shop-products-area">
            <h5 class="text-center mt-3"><?php echo $category_name2;?> <span class="text-danger">(Total Price - <?php echo $total_category_price; ?>)</span> 
            ...
            <button class="mt-3" style="border:none;outline:none;background:none;">👉 Add To Cart (For Buy)</button>
            </form></h5>
            <!-- shop grid products -->
