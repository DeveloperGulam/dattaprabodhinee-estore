...
<!--====================  shop header ====================-->
        <div class="shop-header bg-color--grey">
            <div class="container space-y--15">
                <div class="row align-items-center">
                    ...
                    <div class="col-6">
                        <h1 class="category-title text-center">All Categories</h1>
                    </div>
                        ...
                        <div class="col-6">
                            <div class="grid-product space-mb--20">
                                <div class="grid-product__image">
                                    <a href="<?php echo base_url('products/'.strtolower(str_replace(' ', '-',$sub_categories->id))).'/';?>">
                                        <img src="<?php echo base_url('assets/images/sub_category/'.$sub_categories->sub_category_img);?>" class="img-fluid" alt="">
                                    </a>
	   ...
	   title="More share options" class="lid a2a_dd"><span class="fa fa-share-alt"></span></a></div>
                                ...
                                <div class="grid-product__content">
                                    <h3 class="title" style="font-size:15px;"><a href="<?php echo base_url('products/'.strtolower(str_replace(' ', '-',$sub_categories->id))).'/';?>"><?php echo $sub_categories->sub_category_name; ?></a></h3>
                                    <span class="category"><?php if($sub_categories->stock>'0'){
                                    ...
                                    <div class="price mb-1">
                                        <span class="main-price">₹<?php echo $sub_categories->orignal_price; ?></span>
                                        <span class="discounted-price">₹<?php echo $sub_categories->price; ?></span>
                                    </div>
                                    <div class="price mb-1">
                                        <a type="button" href="<?php echo $sub_categories->youtube;?>" class="btn btn-danger btn-sm"> YouTube</a> <a type="button" href="<?php echo $sub_categories->blog;?>" class="btn btn-success btn-sm"> Link</a>
                                    </div>
									<form method="post" action="<?php echo base_url('Welcome_controller/add_to_cart2/'.$sub_categories->id).'/shop-by-categories/14/utara-upaay/'; ?>">
									<input type="hidden" name="qty" value="1"/>
                                        <button class="btn btn-outline-success form-control btn-sm" style="font-size:11px;">Add To Cart (Buy)</button>
									</form>
                                </div>
                            </div>
                        </div>
